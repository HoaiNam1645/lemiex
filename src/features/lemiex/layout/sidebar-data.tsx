...
const LEMIEX_SIDEBAR_LABELS = {
  vi: {
    ...
    stores: 'Cửa hàng',
    partnerStores: 'Shop đối tác',
    partnerApps: 'Partner Apps',
    syncedOrders: 'Đơn đã sync',
    tickets: 'Khiếu nại',
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: labels.syncedOrders,
          url: '/lemiex/list-sync-orders',
          icon: ReceiptText,
        },
        {
        ...
        {
          title: labels.partnerStores,
          url: '/lemiex/partner-stores',
          icon: Store,
        },
        {
          title: labels.partnerApps,
          url: '/lemiex/partner-apps',
          icon: Link2,
        },
        {
