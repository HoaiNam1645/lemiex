...
type FormState = {
  ...
  style: string
  status: boolean
  category_type: 'embroidery' | 'print'
  mockup: string
  brand: string
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='space-y-5 px-6 py-5'>
            <div className='grid gap-4 md:grid-cols-2'>
              ...
              <div className='space-y-2'>
                <label className='text-sm font-medium'>{m.category}</label>
                <Select
                  value={form.category_type}
                  onValueChange={(value) =>
                    setForm((p) => ({
                      ...p,
                      category_type: value as 'embroidery' | 'print',
                    }))
                  }
                >
                  ...
                  <SelectContent>
                    <SelectItem value='embroidery'>{m.embroidery}</SelectItem>
                    <SelectItem value='print'>{m.print}</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className='space-y-2 md:col-span-2'>
                ...
                <Input
                  className='h-11 rounded-[6px] px-4 text-[14px]'
                  value={form.mockup}
                  onChange={(e) => setForm((p) => ({ ...p, mockup: e.target.value }))}
