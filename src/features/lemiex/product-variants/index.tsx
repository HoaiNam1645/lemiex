...
function parseSearchParams(searchParams: URLSearchParams): ProductVariantsPageState {
  return {
    tab: (searchParams.get('tab') || 'embroidery') as ProductVariantsTab,
          ...
          <div className='flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between'>
            ...
            {!isSeller ? (
              <div className='flex flex-nowrap items-center gap-2 overflow-x-auto'>
                ...
                <Button
                  className='rounded-[6px]'
                  onClick={() => router.push('/lemiex/products/create')}
                >
            ...
            <div className='flex flex-wrap items-center gap-3'>
              <Tabs
                ...
                onValueChange={(value) =>
                  updateUrl({
                    ...state,
                    tab: value as ProductVariantsTab,
                    page: 1,
                  })
                }
              >
                <TabsList className='rounded-[6px]'>
                  <TabsTrigger value='embroidery' className='rounded-[6px]'>
                    {productMessages.tabs.embroidery}
                  </TabsTrigger>
                  <TabsTrigger value='print' className='rounded-[6px]'>
                    {productMessages.tabs.print}
                  </TabsTrigger>
                </TabsList>
              </Tabs>
            </div>
