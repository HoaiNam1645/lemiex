    ...
    <div className='flex min-h-svh items-center justify-center bg-background px-4 py-10 sm:px-6'>
      <Card className='relative z-10 w-full max-w-md border-border/80 bg-card/95 shadow-[0_24px_80px_rgba(0,0,0,0.08)] backdrop-blur-sm dark:shadow-[0_24px_80px_rgba(0,0,0,0.35)]'>
        <CardHeader className='space-y-5 text-center'>
          <div className='mx-auto flex h-20 w-20 items-center justify-center rounded-3xl border border-border bg-background shadow-sm'>
            <Image
              src='/images/logo/logo-lemiex.png'
              alt='Lemiex logo'
              width={64}
              height={64}
          ...
          <div className='space-y-2'>
            ...
            <CardDescription className='text-sm leading-6'>
              Nhập tài khoản của bạn để truy cập hệ thống quản trị Lemiex.
            </CardDescription>
          </div>
        </CardHeader>
        <CardContent>
